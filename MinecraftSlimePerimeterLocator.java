...
public class MinecraftSlimePerimeterLocator {
    public static void main(String[] args) {
        ...
        System.out.println("Searching Slime chunk(s) in range...");
        ...
        System.out.println("Successfully searched slime chunk(s) in range!");
        ...
        for (int x = central_chunk_x_start; x <= central_chunk_x_end; x++) {
            for (int z = central_chunk_z_start; z <= central_chunk_z_end; z++) {
                ...
                if (effective_chunks >= min_slime_chunk_requirement) {
                    ...
                    System.out.println(String.format("Found: effective chunks: %d, effective blocks: %d, central chunk: (%d, %d)", effective_chunks, effective_blocks, x, z));
                }
            }
        }

        System.out.println(String.format("Successfully found %d eligible central chunk(s)!", total));
    }
